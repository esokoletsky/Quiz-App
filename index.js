    ...
    <form>
      ...
      <legend>options to questions</legend>
        <ul>
          ...
          <li>
            <label>
              <input value="${current.ans1}" value="choice-1" type="radio" aria-label="${current.ans1}" role="button" id="${current.ans1}" required>
          ...
          <li>
            <label>
              <input value="${current.ans2}" value="choice-2" type="radio" aria-label="${current.ans2}" role="button" id="${current.ans2}" required>
          ...
          <li>
            <label>
              <input  value="${current.ans3}" value="choice-3"type="radio" aria-label="${current.ans3}" role="button" id="${current.ans3}" required>
          ...
          <li>
            <label>
              <input value="${current.ans4}" value="choice-4"type="radio" aria-label="${current.ans4}" role="button" id="${current.ans4}" required>
